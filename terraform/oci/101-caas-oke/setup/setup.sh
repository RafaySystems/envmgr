...
mkdir -p ../../../../rafay-resources/projects/$project/drivers
cp $PWD/spec/${spec_array[6]}.yaml  ../../../../rafay-resources/projects/$project/drivers/
...
cp $PWD/spec/${spec_array[12]}.yaml  ../../../../rafay-resources/projects/$project/environmenttemplates/
